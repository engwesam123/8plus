        ...
        <div class="row">
            ...
            <!--begin::Portlet-->
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form autocomplete="off" id="form_input" class="kt-form" action="{{ route('how_works.update',$howwork->id) }}"
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center mb-5">
                                    <div class="kt-avatar kt-avatar--outline kt-avatar--circle-" >
                                        <div class="kt-avatar__holder" id="imagePreview" style="background-image: url({{ $howwork->image }});"></div>
                                ...
                                @foreach (config('translatable.locales') as $local)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $howwork->translate($local)->title }}"
                                             name="{{$local}}[title]" class="form-control" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                 @endforeach
                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="{{$local}}[description]"
                                                ...
                                                rows="6">{{ $howwork->translate($local)->description }}</textarea>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
