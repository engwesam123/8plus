        ...
        <div class="row">
            ...
            <!--begin::Portlet-->
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form autocomplete="off" id="form_input" class="kt-form" action="{{ route('leader_ship.store') }}"
                                ...
                                @foreach (config('translatable.locales') as $local)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  value="{{ old($local.'.job') }}" name="{{$local}}[job]" class="form-control" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                 @endforeach
                            </div>
