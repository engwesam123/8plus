        ...
        <div class="row">
            ...
            <!--begin::Portlet-->
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form autocomplete="off" id="form_input" class="kt-form" action="{{ route('service.update',$service->id) }}"
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center mb-5">
                                    <div class="kt-avatar kt-avatar--outline kt-avatar--circle-" >
                                        <div class="kt-avatar__holder" id="imagePreview" style="background-image: url({{ $service->image }});"></div>
                                ...
                                @foreach (config('translatable.locales') as $local)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $service->translate($local)->name }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control summernote" name="{{$local}}[description]"
                                                ...
                                                rows="6">{{ $service->translate($local)->description }}</textarea>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
