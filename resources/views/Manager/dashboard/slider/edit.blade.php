        ...
        <div class="row">
            ...
            <!--begin::Portlet-->
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form autocomplete="off" id="form_input" class="kt-form" action="{{ route('slider.update',$slider->id) }}"
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center mb-5">
                                    <div class="kt-avatar kt-avatar--outline kt-avatar--circle-" >
                                        <div class="kt-avatar__holder" id="imagePreview" style="background-image: url({{ $slider->image}});"></div>
                                        ...
                                        <span class="mt-3 d-block">  W 1920 / H 700</span>
                                ...
                                @foreach (config('translatable.locales') as $local)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $slider->translate($local)->title }}"
