        ...
        <div class="row">
            ...
            <!--begin::Portlet-->
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form autocomplete="off" id="form_input" class="kt-form" action="{{ route('project.update',$project->id) }}"
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center mb-5">
                                    <div class="kt-avatar kt-avatar--outline kt-avatar--circle-" >
                                        <div class="kt-avatar__holder" id="imagePreview" style="background-image: url({{ $project->image }});"></div>
                            ...
                            <div class="row">
                                ...
                                @foreach (config('translatable.locales') as $local)
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $project->translate($local)->project_name }}" name="{{$local}}[project_name]" class="form-control" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $project->translate($local)->client_name }}" name="{{$local}}[client_name]" class="form-control" aria-describedby="emailHelp">
                                    </div>
                                </div>
                            @endforeach
                                ...
                                @foreach (config('translatable.locales') as $local)
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $project->translate($local)->location }}" name="{{$local}}[location]" class="form-control" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                @foreach (config('translatable.locales') as $local)
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $project->translate($local)->project_type }}" name="{{$local}}[project_type]" class="form-control" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                @endforeach
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    <select class="form-control select2" multiple name="services_id[]">
                                        @foreach ($services as $service)
                                            <option
                                            @foreach ($project->services as $project_service)
                                                {{ $service->id == $project_service->id ? 'selected' : '' }}
                                            @endforeach
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $project->project_cost }}" type="text" name="project_cost" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="datetimepicker1" value="{{ $project->project_bulid_date }}" type="text" name="project_bulid_date" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <br>
                                    <div class="form-group row align-items-center  mb-5">
                                        ...
                                        <div class="col-8">
                                            <span class="kt-switch ">
                                                <label class="mb-0">
                                                    <input  {{ $project->status == 1 ? 'checked' : '' }}
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group row align-items-center  mb-5">
                                        ...
                                        <div class="col-8">
                                            <span class="kt-switch ">
                                                <label class="mb-0">
                                                    <input {{ $project->view_status == 1 ? 'checked' : '' }}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="{{$local}}[description]"
                                                ...
                                                rows="6">{{ $project->translate($local)->description }}</textarea>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
