        ...
        <div class="row">
            ...
            <!--begin::Portlet-->
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form autocomplete="off" id="form_input" class="kt-form" action="{{ route('manager_word.update',$manager_word->id) }}"
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center mb-5">
                                    <div class="kt-avatar kt-avatar--outline kt-avatar--circle-" >
                                        <div class="kt-avatar__holder" id="imagePreview" style="background-image: url({{ $manager_word->image}});"></div>
                                        ...
                                        <span class="mt-3 d-block text-center">  W 1920 / H 550</span>
                                ...
                                @foreach (config('translatable.locales') as $local)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $manager_word->translate($local)->name }}"
                                             name="{{$local}}[name]" class="form-control" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                 @endforeach
                            </div>
                                ...
                                @foreach (config('translatable.locales') as $local)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $manager_word->translate($local)->job }}"
                                             name="{{$local}}[job]" class="form-control" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                 @endforeach
                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control summernote" name="{{$local}}[description]"
                                                      ...
                                                      rows="10">{{  $manager_word->translate($local)->description  }}</textarea>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
...
{{--                                            <textarea class="form-control summernote" name="{{$local}}[description]"--}}
{{--                                                id="exampleFormControlTextarea1"--}}
{{--                                                rows="9">{{ $manager_word->translate($local)->description }}</textarea>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                @endforeach--}}
{{--                            </div>--}}
